...
@section('content')
    <div class="row justify-content-center">
        <div class="col-md-10 mt-5">
            <h2>Cadastro de Vermífugo</h2>

            <form action="{{ route('vermifugo.adicionar') }}" method="POST">
                @csrf

                <div class="col-sm">
                    <p>Informe os dados do Vermífugo que será vinculada ao animal: <strong>{{ $animal->nome }}</strong>.</p>
                ...
                <a href="{{ route('vermifugos.listar', $animal->id) }}" class="btn btn-secondary m-2">Voltar</a>
